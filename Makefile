...
pkgdatadir = $(datadir)/aprcoin
pkgincludedir = $(includedir)/aprcoin
pkglibdir = $(libdir)/aprcoin
pkglibexecdir = $(libexecdir)/aprcoin
...
CONFIG_HEADER = $(top_builddir)/src/config/aprcoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/aprcoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = aprcoin-cli
BITCOIN_DAEMON_NAME = aprcoind
BITCOIN_GUI_NAME = aprcoin-qt
BITCOIN_TX_NAME = aprcoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = aprcoin
PACKAGE_BUGREPORT = www.apr-coin.com
PACKAGE_NAME = APR Coin Core
PACKAGE_STRING = APR Coin Core 2.0.0
PACKAGE_TARNAME = aprcoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository
abs_srcdir = /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository
abs_top_builddir = /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository
abs_top_srcdir = /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/holy/Work/Tasks/06_APR/Ubuntu/zenith-repository/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_aprcoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_aprcoin_coverage.info test_aprcoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/AprCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/aprcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/aprcoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/aprcoin-config.h
$(top_srcdir)/src/config/aprcoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/aprcoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/AprCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/AprCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/AprCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_aprcoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_aprcoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_aprcoin_filtered.info: test_aprcoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_aprcoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_aprcoin_coverage.info: baseline_filtered_combined.info test_aprcoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_aprcoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_aprcoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_aprcoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_aprcoin.coverage/.dirstamp:  test_aprcoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_aprcoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_aprcoin.coverage/ total.coverage/ $(OSX_APP)
