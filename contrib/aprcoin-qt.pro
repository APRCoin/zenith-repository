...
RESOURCES += src/qt/aprcoin.qrc src/qt/aprcoin_locale.qrc

TRANSLATIONS += src/qt/locale/aprcoin_bg.ts \
                src/qt/locale/aprcoin_de.ts \
                src/qt/locale/aprcoin_en.ts \
                src/qt/locale/aprcoin_es.ts \
                src/qt/locale/aprcoin_fi.ts \
                src/qt/locale/aprcoin_fr.ts \
                src/qt/locale/aprcoin_it.ts \
                src/qt/locale/aprcoin_ja.ts \
                src/qt/locale/aprcoin_pl.ts \
                src/qt/locale/aprcoin_pt.ts \
                src/qt/locale/aprcoin_ru.ts \
                src/qt/locale/aprcoin_sk.ts \
                src/qt/locale/aprcoin_sv.ts \
                src/qt/locale/aprcoin_vi.ts \
                src/qt/locale/aprcoin_zh_CN.ts \
                src/qt/locale/aprcoin_zh_TW.ts
