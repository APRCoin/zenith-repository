Contributing to APR Coin Core
==================================

The APR Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the APR Coin Core project, and is not to be
confused with overall APR Coin Network Protocol consensus changes.

Whether a pull request is merged into APR Coin Core rests with the project merge
...
Patches that change APR Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the APR Coin consensus, it must have been
...
The project leader is the release manager for each APR Coin Core release.
