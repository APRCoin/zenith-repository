...
#   c) node1 mines 32 blocks, so now node 0 has 500000APR, node 1 has 4250APR, node2 has none.
#   d) node0 sends 601 APR to node2, in two transactions (301 APR, then 300 APR).
