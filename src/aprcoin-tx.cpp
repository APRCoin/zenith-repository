...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("APR Coin Core aprcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aprcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded APR Coin transaction") + "\n" +
                               "  aprcoin-tx [options] -create [commands]   " + _("Create hex-encoded APR Coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded APR Coin transaction
