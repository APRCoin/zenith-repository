...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop APR Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "APR Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* APR Coin features */
        {"aprcoin", "masternode", &masternode, true, true, false},
        {"aprcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"aprcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aprcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aprcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aprcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"aprcoin", "startmasternode", &startmasternode, true, true, false},
        {"aprcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aprcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aprcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aprcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aprcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aprcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aprcoin", "mnbudget", &mnbudget, true, true, false},
        {"aprcoin", "preparebudget", &preparebudget, true, true, false},
        {"aprcoin", "submitbudget", &submitbudget, true, true, false},
        {"aprcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aprcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aprcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aprcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aprcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aprcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aprcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aprcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"aprcoin", "mnsync", &mnsync, true, true, false},
        {"aprcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> aprcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3132/\n";
}
