...
// Copyright (c) 2017 The APR Coin Core developers
 ...
 * APR Coin system. There are three: the main network on which people trade goods
...
public:
    ...
    int LAST_POW_BLOCK1() const { return nLastPOWBlock1; }
    int LAST_POW_BLOCK2() const { return nLastPOWBlock2; }
