                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("APR Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a APR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aprcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About APR Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about APR Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for APR Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your APR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified APR addresses"));
    ...
    openAction->setStatusTip(tr("Open a aprcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the APR Coin Core help message to get a list with possible APR Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("APR Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to APR Coin network", "", count));
}
...
{
    QString strTitle = tr("APR Coin Core"); // default title
