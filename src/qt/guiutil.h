...
/** Utility functions used by the AprCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render APR addresses in monospace font
...
// Parse "aprcoin:" URI into recipient object, return true on successful parsing
