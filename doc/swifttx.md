...
This mechanism has been integrated into Bitcore-Node-AprCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/aprcoin/insight-api-aprcoin#web-socket-api](https://github.com/aprcoin/insight-api-aprcoin#web-socket-api)
* API: [https://github.com/aprcoin/insight-api-aprcoin#swifttx-transactions](https://github.com/aprcoin/insight-api-aprcoin#swifttx-transactions)
...
By default, the APR Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the APR Coin Core daemon:
