...
Intro
-----
APR Coin (APR) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. APR Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run aprcoin-qt.exe.

APR Coin Core is the original APR Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of APR Coin transactions;
