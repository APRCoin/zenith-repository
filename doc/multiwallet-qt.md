...
In order to support loading of multiple wallets in aprcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aprcoin.cpp.
...
Changes to aprcoin.cpp
----------------------
aprcoin.cpp is the entry point into aprcoin-qt, and as such, will require some minor modifications to provide hooks for
